...
def CompleteTask(USER):
       ...
       Label(newWindow, text="Complete Task",width=30,bg='#E9E9E5',fg='black', font=("Elephant", 20)).place(x=0, y=70)
       today = date.today()
       ...
       for room in rooms:
              ...
              counter = counter + 1
       label_rooms = Label(newWindow, text="Choose rooms:",width=20,bg='#E9E9E5',fg='black', font=("Elephant", 15))
       ...
       Button(newWindow, command=buttonHandler, text='Submit', width=20, bg='#5C715E',fg='white').place(x=350, y=250)
...
def ShowMePetByRoom(USER):
       ...
       PetByRoom.state("zoomed")
       PetByRoom.configure(background='#E9E9E5')
       topLabel = Label(PetByRoom,text='',width=90, bg='#D4D6C8',fg='black',font=('Verdana Pro Black',30))
       topLabel.pack(side=TOP)
       bottomLabel = Label(PetByRoom,text='',width=90, bg='#D4D6C8',fg='black',font=('Verdana Pro Black',30))
       bottomLabel.pack(side=BOTTOM)
       Label(PetByRoom, text="Pet's details by room number",width=30,bg='#E9E9E5',fg='black', font=("Elephant", 20)).place(x=0, y=80)
       today = date.today()
       todayDate = f'{today.month}/{today.day}/{today.year}'
       label_room = Label(PetByRoom, text="Enter room number Please:",width=23, bg='#E9E9E5',fg='black',font=("bold", 15))
       ...
       def PetsDetailsPopUp():
              ...
              text+='ID: '+Pet[5]+'\n'
              popupmsg(text)
       Button(PetByRoom, command=PetsDetailsPopUp, text='Submit', width=20, bg='#5C715E',fg='white').place(x=600, y=500)
...
def homepageWORKER(USER):
       ...
       topLabel = Label(workerHomePage,text='',width=90, bg='#D4D6C8',fg='black',font=('Verdana Pro Black',30))
       topLabel.pack(side=TOP)
       bottomLabel = Label(workerHomePage,text='',width=90, bg='#D4D6C8',fg='black',font=('Verdana Pro Black',30))
       bottomLabel.pack(side=BOTTOM)
       Label(workerHomePage, text="worker Homepage:",width=30,bg='#E9E9E5',fg='black', font=("Elephant", 20)).place(x=30, y=120)
       Button(workerHomePage, text="Complete task",width=30, bg='#D4D6C8',fg='black',font=('Elephant',13),command=lambda:CompleteTask(USER)).place(x=450, y=240)
       Button(workerHomePage, text="Quit",width=30, bg='#D4D6C8',fg='black',font=('Elephant',13),command=root.destroy).place(x=450, y=420)
       Button(workerHomePage, text="My rooms",width=30, bg='#D4D6C8',fg='black',font=('Elephant',13),command=lambda :ShowMeMyRooms(USER)).place(x=450, y=360)
       Button(workerHomePage, text="Pet's details by room number",width=30, bg='#D4D6C8',fg='black',font=('Elephant',13),command=lambda :ShowMePetByRoom(USER)).place(x=450, y=300)
